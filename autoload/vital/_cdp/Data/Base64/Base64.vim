...
execute join(['function! vital#_cdp#Data#Base64#Base64#import() abort', printf("return map({'b64encode': '', 'b64decode': ''}, \"vital#_cdp#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
